...
--> byte 6: adcRange  // no longer a parameter we want to change 
  - 0 = 2048
  - 1 = 4096 
  - 2 = 8192 (default)
  - 3 = 16384
...
//--> adding this
uint16_t getPPGBrightness() {
  switch (ppgConfigData[5]) {
    case 0: return 0x01h;
    case 1: return 0x02h;
    case 2: return 0x04h; //unsure what the exact name is
    case 3: return 0x08h;  //unsure what the exact name is
    case 4: return 0x0Fh;
    case 5: return 0x1F;
    case 6: return 0x3Fh;
    case 7: return 0x7Fh;
...
// uint16_t getADCRange() {
//   switch (ppgConfigData[6]) {
//     case 0: return 2048;
//     case 1: return 4096; //default
//     case 2: return 8192;
//     case 3: return 16384;
//     default: return 0;
//   }
...
//--> adding in green value
  ...
  ppgDataBuf[ppgCursor++] = (greem >> 16) & 0xFF;
